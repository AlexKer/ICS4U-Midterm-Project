...
public class TicTacToeLogic {
	...
	// displays the array passed in the representation of a board in console
	// either one 3-d array or three 1-d array can be passed in
	...
	public void drawBoard(char[] firstRow, char[] secondRow, char[] thirdRow) {
		for (int i : firstRow) {
